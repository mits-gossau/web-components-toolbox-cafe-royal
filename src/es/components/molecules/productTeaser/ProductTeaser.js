 ...
 */
export default class ProductTeaser extends Intersection() {
  ...
  renderCSS () {
    ...
    this.css = /* css */`
      ...
      :host figure {
        ...
        align-items: var(--product-teaser-align-items, var(--align-items, flex-start));
        justify-content: var(--product-teaser-justify-content, var(--justify-content, space-between));
        margin: var(--margin, 0);
      ...
      :host figure figcaption {
        ...
        text-align: var(--figcaption-text-align, center);
      }
      ...
      :host figure figcaption h2, :host figure figcaption h6 {
        ...
        margin-top: var(--h2-figcaption-margin-top, var(--h2-figcaption-margin, var(--figcaption-margin-top, var(--figcaption-margin, 0.83em))));
        margin-bottom: var(--h2-figcaption-margin-bottom, var(--h2-figcaption-margin, var(--figcaption-margin-bottom, var(--figcaption-margin, 0.83em))));
      }
      :host(:hover) figure figcaption * {
